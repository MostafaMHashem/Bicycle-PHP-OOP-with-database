...
<dl>
  <dt>Brand</dt> 
  <!-- we added an array to the name to simplify the $args = [] when we $_POST request  -->
  <!-- so now we could simply ask for $args = $_POST['bicycle'] -->
  <!-- it return to us an html associtve array key=>vale  -->
